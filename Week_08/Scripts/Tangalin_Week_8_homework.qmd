...
library(patchwork) #combine two ggplots, tried
library(cowplot) #pre-patchwork
...
knitr::include_graphics(here("Week_08", "Output", "hawaii_accidents_overlay.png"))
```
...
```{r, echo=FALSE, out.width="80%"}
 knitr::include_graphics(here("Week_08", "Output", "lollipop_with_tacoma_corner.png"))
```
